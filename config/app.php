...
return [
    ...
    */
    ...
    'VIEWVALIDITYDAYS' => env('VIEWVALIDITYDAYS', 90),
    'TTCASH_DOLLAR' => env('TTCASH_DOLLAR', 1),
    'BRAINTREE' => [
        'ENV' => env('BRAINTREE_ENV', 'sandbox'),
        'MERCHANTID' => env('BRAINTREE_MERCHANTID', 'brfnhtmtp2n8363m'),
        'PUBLICKEY' => env('BRAINTREE_PUBLICKEY', '29x6kd522hzyyvjt'),
        'PRIVATEKEY' => env('BRAINTREE_PRIVATEKEY', '5631849eb8a8a0452777e40dc0eb5111')
    ]
];
