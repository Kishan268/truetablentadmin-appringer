...
return [
    ...
    */
    ...
    'google' => [
        'client_id' => env('GOOGLE_CLIENT_ID','618052979392-nrbp2u1mhqjbvan057c1f1hg13vvq60f.apps.googleusercontent.com'),
        'client_secret' => env('GOOGLE_SECRET','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'),
        'redirect' => env('GOOGLE_REDIRECT','https://tt.appringer.co.in/auth/google'),
    ],
];
