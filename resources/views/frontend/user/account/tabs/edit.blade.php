    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <div>
                    <input type="radio" name="avatar_type" value="storage" {{ $logged_in_user->avatar_type == 'storage' ? 'checked' : '' }} /> Upload from local system
                    <input class="ml-5" type="radio" name="avatar_type" value="gravatar" {{ $logged_in_user->avatar_type == 'gravatar' ? 'checked' : '' }} /> Gravatar

                    @if(is_array($logged_in_user->providers))
