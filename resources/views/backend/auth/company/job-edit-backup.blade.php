            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            <select class="form-control location-select2" multiple="multiple" name="work_locations[]"
                                id="work_locations">
                                    ...
                                    @foreach ($data['location'] as $location)
                                        ...
                                        <?php 
                                            ...
                                            if (isset($jobs->company_jod_detail)) {
                                                ...
                                                if (in_array($location->id,$data_id))
                                                  {
                                                  echo 'selected';
                                                  }
                                                else
                                        ...
                                        ?> >
                                            {{ $location->name . ', ' . $location->description }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-control skill-select2" multiple="multiple" name="required_skills[]"
                                id="required_skills">
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-control skill-select2" multiple="multiple" name="additional_skills[]"
                                id="additional_skills">
                                @if (count($data['skills']) > 0)
                                    @foreach ($data['skills'] as $skill)
                                        <option value="{{ $skill->name }}" <?php 
                                            $data_id = [];
                                            if (isset($jobs->company_jod_detail)) {
                                                foreach ($jobs->company_jod_detail as $key => $company_jod_detail) {
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                <input style="width: 100%" type="number" min="0"
                                    ...
                                    value="{{ $jobs->minimum_experience_required ? $jobs->minimum_experience_required : old('minimum_experience_required') }}" id="minimum_experience_required" class="form-control" />
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                <input style="width: 100%" type="number" min="0"
                                    ...
                                    value="{{ $jobs->maximum_experience_required ? $jobs->maximum_experience_required : old('maximum_experience_required') }}" id="maximum_experience_required" class="form-control" />
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-control custom-select2" name="industry_domain_id" id="industry_domain">
                    ...
                    <div class="form-group row  mt-2">
                        <label class="col-md-2 form-control-label" for="industry_domain"></label>
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-control custom-select2" name="job_duration_id" id="job_duration">
