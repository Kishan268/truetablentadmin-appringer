...
@section('content')
    {{-- {{ html()->form('POST', route('admin.auth.company.job.store'))->class('form-horizontal')->id('basic-form')->open() }} --}}
    {{-- {{ html()->form('POST', route('admin.auth.company.job.store'))->class('form-horizontal')->id('basic-form')->open() }} --}}
    <form class="form-horizontal" action="{{route('admin.auth.company.job.store')}}" method="POST" id="basic-form">
        @csrf
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control custom-select2" name="company_id" id="company_id" required>
                    ...
                    <div class="form-group row mt-2">
                        <label class="col-md-2 form-control-label required">Company User</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="title" id="title" placeholder="Job Title"
                                maxlength="191" autofocus="" value="{{ old('title') }}" required>
                                ...
                                @foreach ($data['job_types'] as $job_type)
                                    <div class="form-check radio-check">
                                        <label class="form-check-label" htmlFor="job_type{{ $job_type->id }}">
                                            {{ $job_type->name }}
                                        <input name="job_type_id" id="job_type{{ $job_type->id }}" class="form-check-input salary_type"
                                            type="radio" value="{{ $job_type->id }}" id="job_type_id" />
                    ...
                    <div class="form-group row  mt-4">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" multiple name="work_locations[]" id="work_locations"></select>
                    ...
                    <div class="form-group row  mt-4">
                        ...
                        <div class="col-md-10">
                            <label class="input-lebel" htmlFor="">
                                Required Skills
                            </label>
                             <select class="js-data-example-ajax form-control skill-select2" multiple name="required_skills[]" id="required_skills"></select>
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class="col-md-10">
                            <label class="input-lebel required" htmlFor="">
                             ...
                             <select class="form-control skill-select2" multiple name="additional_skills[]" id="additional_skills"></select>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                <input style="width: 100%" type="number" min="0"
                                    ...
                                    value="{{ old('minimum_experience_required') }}" id="minimum_experience_required" class="form-control" />
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                <input style="width: 100%" type="number" min="0"
                                    ...
                                    value="{{ old('maximum_experience_required') }}" id="maximum_experience_required" class="form-control"/>
                                    ...
                                    @foreach ($data['salary_types'] as $salary_type)
                                        <div class="col-3 form-check radio-check">
                                            ...
                                            <input name="salary_type_id" id="salary_type{{ $salary_type->id }}"
                                                class="form-check-input salary_type_id" type="radio"
                                                value="{{ $salary_type->id }}" id="salary_type_id" />
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group min_sal_inp">
                                        ...
                                        <input type="text" name="min_salary" class="form-control "
                                            placeholder="XXXXXX" id="min_salary"  />
                                ...
                                <div class="col">
                                    <div class="input-group min_sal_inp">
                                        ...
                                        <input type="text" name="max_salary" class="form-control "
                                            placeholder="XXXXXX" id="max_salary" />
                                    ...
                                    @foreach ($data['benefits'] as $benefit)
                                        <div class="col form-check">
                                            <input class="form-check-input" type="checkbox" name="benefits[]"
                                                id="{{ $benefit->id }}" value="{{ $benefit->id }}" />
                    ...
                    <div class="form-group row  mt-4">
                        <label class="col-md-2 form-control-label" for="industry_domain_id">Other Requirements</label>
                            ...
                            <select class="form-control custom-select2" name="industry_domain_id" id="industry_domain_id">
                                ...
                                @if (count($data['industry_domains']) > 0)
                                    @foreach ($data['industry_domains'] as $industry_domain)
                                        <option value="{{ $industry_domain->id }}">{{ $industry_domain->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row  mt-2">
                        <label class="col-md-2 form-control-label" for="joining_preference_id"></label>
                            ...
                            <select class="form-control custom-select2" name="joining_preference_id"
                                ...
                                @if (count($data['joining_preferences']) > 0)
                                    @foreach ($data['joining_preferences'] as $joining_preference)
                                        <option value="{{ $joining_preference->id }}">{{ $joining_preference->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select class="form-control custom-select2" name="job_duration_id" id="job_duration_id">
                                ...
                                @if (count($data['job_durations']) > 0)
                                    @foreach ($data['job_durations'] as $job_duration)
                                        <option value="{{ $job_duration->id }}">{{ $job_duration->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row  mt-2">
                        ...
                        <div class='col-3'>
                            ...
                            <label class="switch mt-1 form-switch" style="position: absolute;">
                                <input type="checkbox" value="1" name="is_telecommute" class="switch-input form-check-input" />
                        ...
                        <div class='col-3'>
                            ...
                            <label class="switch mt-1" style="position: absolute;">
                                <input type="checkbox" value="1" id="travel_required" name="is_travel_required" />
                                <span class="slider round"></span>
                            </label>
                        </div>
                        <div class='col-4 travel_percentage' style="display: none;">
                            <input style="width: 90%" type="range" class="form-range" min="0" max="100"
                                step="25" id="customRange3" name="travel_percentage" value="0"></input>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#save-draft').on('click',function(){
            ...
            var status = $('#job_type_save_action').val('draft')
        ...
        $('#save-job').on('click',function(){
            ...
            var status = $('#job_type_save_action').val('published')
            $("#basic-form").validate({
        ...
        var save = $('#job_type_save_action').val();
