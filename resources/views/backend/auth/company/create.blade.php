...
@section('content')
    ...
    <form class="form-horizontal" action="{{ route('admin.auth.company.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="company_name" id="company_name" placeholder="Company Name" maxlength="191" required="" autofocus="" value="{{ old('company_name') }}">
                        ...
                        <div class="form-group row  mt-2">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="website" name="website" id="website" placeholder="Website" maxlength="191" required="" autofocus="" value="{{ old('website') }}">
                                ...
                                <select class="form-control select2" name="location" id="location" required>
                                    ...
                                    @if(count($data['location']) > 0)
                                        @foreach($data['location'] AS $location)
                                            <option value="{{ $location->id }}" {{ (collect(old('location'))->contains($location->id)) ? 'selected':'' }}>{{ $location->name.', '.$location->description }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div><!--col-->
                        ...
                        <div class="form-group row  mt-2">
                         ...
                         <div class="form-group row  mt-2">
                            ...
                            <div class="col-md-10">
                                 <input class="form-control" type="file" name="logo" id="logo" placeholder="Website" maxlength="191"  autofocus="" value="{{ old('logo')}}">

                            </div><!--col-->
                        </div>
                        <div class="form-group row  mt-2">
                            <label class="col-md-2 form-control-label" for="cover_pic">Cover Image</label>
                            <div class="col-md-10">
                                 <input class="form-control" type="file" name="cover_pic" id="cover_pic" placeholder="Website" maxlength="191"  autofocus="" value="{{ old('cover_pic')}}">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //  $(document).keypress('#location', (e) => {
        //     const selectId = e.target.id
        //     $("#location").select2('open').focus();

        //     // alert("select2-search__field[aria-controls='select2-" + selectId + "-results']")
