...
class UserRepository extends BaseRepository
{
     ...
     */
    public function create(array $data, string $type, $company_id)
    {
        return DB::transaction(function () use ($data, $type, $company_id) {
            ...
            if ($user && $type) {
                if($type == 'corporate'){
                    $type = 'company admin';
                }elseif ($type == 'company_user') {
                    $type = config('access.users.company_user_role');
                }else{
                    $type = config('access.users.default_role');
                }
