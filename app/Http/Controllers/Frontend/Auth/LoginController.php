...
class LoginController extends Controller
{
    ...
    protected function authenticated(Request $request, $user)
    {
        ...
        // if (!$user->hasanyrole('administrator | agency')) {
        //     auth()->logout();

        //     throw new GeneralException(__('exceptions.frontend.auth.not_authorize'));
        // }
        ...
        // Redirect Company Admin to My Posted Jobs
        if(auth()->user()->roles[0]->name == config('access.users.company_admin_role')){
            return redirect()->intended(route('frontend.company.jobs'));    
        }
