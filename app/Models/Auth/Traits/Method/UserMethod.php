...
trait UserMethod
{
    ...
    {
        return $this->hasRole(config('access.users.candidate_role'));
    }
    ...
    {
        return $this->hasRole(config('access.users.evaluator_role'));
    }
    ...
    {
        return $this->hasRole(config('access.users.company_user_role'));
    }
