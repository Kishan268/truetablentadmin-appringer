...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Role::create(['name' => config('access.users.company_admin_role')]);
        Role::create(['name' => config('access.users.company_user_role')]);
        Role::create(['name' => config('access.users.evaluator_role')]);
